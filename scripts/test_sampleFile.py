...
class TestSampple:
    def test_Validatecall(self):
        ...
        log.info("click sign in the button")
        ...
        log.info("locate and enter username")
        ...
        log.info("locate and enter passwod")
